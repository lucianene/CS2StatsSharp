...
public static class StatsPayload
{
    ...
    public static JsonObject ToPlayerObject(PlayerUpload p)
    {
        ...
        var obj = new JsonObject
        {
            ...
            ["noscope_kills"] = s.NoScopeKills,
            ["wallbang_kills"] = s.WallbangKills,
            ["smoke_kills"] = s.SmokeKills,
            ["air_kills"] = s.AirKills,
            ["knife_kills"] = s.KnifeKills,
            ["zeus_kills"] = s.ZeusKills,
            ["he_kills"] = s.HeKills,
            ["molotov_kills"] = s.MolotovKills,
            ["rifle_kills"] = s.RifleKills,
            ["smg_kills"] = s.SmgKills,
            ["shotgun_kills"] = s.ShotgunKills,
            ["double_kills"] = s.DoubleKills,
            ["flash_assists"] = s.FlashAssists,
            ["shots_fired"] = s.ShotsFired,
            ["shots_on_target"] = s.ShotsOnTarget,
            ["accuracy"] = s.Accuracy,
            ["hostage_rescues"] = s.HostageRescues,
            ["flash_thrown"] = s.FlashThrown,
            ["he_thrown"] = s.HeThrown,
            ["smoke_thrown"] = s.SmokeThrown,
            ["molotov_thrown"] = s.MolotovThrown,
            ["decoy_thrown"] = s.DecoyThrown,
            ["dominations"] = s.Dominations,
            ["revenges"] = s.Revenges,
            ["team_wipes"] = s.TeamWipes,
